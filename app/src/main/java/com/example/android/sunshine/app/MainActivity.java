...
public class MainActivity extends AppCompatActivity implements ForecastFragment.Callback {
     ...
     */
    static final String PROJECT_NUMBER = "1053890975309";
    ...
    @Subscribe
    public void onSendDataToWearEventReceived(SendDataToWearEvent event) {
        ...
        Log.d(TAG, "sending data item");
        PutDataMapRequest putDataMapReq = PutDataMapRequest.create("/data");

        putDataMapReq.getDataMap().putString("high", Utility.formatTemperature(this, high));
        putDataMapReq.getDataMap().putString("low", Utility.formatTemperature(this, low));
            ...
            new ResultCallback<DataApi.DataItemResult>() {
                ...
                public void onResult(DataApi.DataItemResult dataItemResult) {
                    if (!dataItemResult.getStatus().isSuccess()) {
                        Log.d(TAG, "Failed to put data item");
                    } else {
                        Log.d(TAG, "data item put successfully");
                    }
                }
            });
    }
